    ...
    projects: [
        {
            ...
            approach: "- Initially, I explored different real-time communication protocols and settled on **WebSockets** for their low-latency, bidirectional capabilities essential for instant drawing updates. For managing user interactions and drawing states, a robust frontend architecture was critical, leading me to use React. The backend was designed with **Node.js** and **Express** to handle concurrent WebSocket connections and manage drawing data persistence efficiently. I prioritized scalability for concurrent users and implemented automated backend tests to ensure reliability of critical API endpoints.",
