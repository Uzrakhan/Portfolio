...
// ⭐ UPDATED helper function for embedding videos (using <video> tag) ⭐
const VideoEmbed = ({ url }) => {
    if (!url) return null;    
    return (
        <div className="relative w-full shadow-2xl rounded-xl overflow-hidden bg-black">
            <video
...
                loop 
                muted
                // Added preload, which can help some browsers
                preload="metadata"
                // Adding the project thumbnail as a poster is great practice
                // poster={project.image} // NOTE: You would need to pass 'project' as a prop
            >
...
const ProjectDetail = () => {
    // ... (GSAP registration and other code remains the same) ...
    gsap.registerPlugin(ScrollTrigger); // Ensure this is present if using GSAP
...
    useEffect(() => {
        // ... (GSAP useEffect logic remains the same) ...
